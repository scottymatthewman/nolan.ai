...
if (!globalThis.DOMException) {
    try {
        const { MessageChannel } = __webpack_require__(1267), port = new MessageChannel().port1, ab = new ArrayBuffer();
        port.postMessage(ab, [
            ab,
            ab
        ]);
...
var node_domexception = __webpack_require__(2489);
// EXTERNAL MODULE: ./node_modules/formdata-node/lib/esm/File.js
var File = __webpack_require__(5530);
...
var isFile = __webpack_require__(9904);
